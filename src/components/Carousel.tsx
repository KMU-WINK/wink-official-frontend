        ...
        <div className="flex flex-col items-center justify-center">
                    ...
                    {cards.map((card, index) => (
                        <div
                            ...
                            style={{
                                ...
                                filter: currentIndex !== index && card.imageUrl ? 'brightness(0.5) blur(2px)' : 'none',
                                boxShadow: currentIndex === index && card.imageUrl ? '0 4px 8px rgba(0, 0, 0, 0.5)' : 'none',
                            }}
                        />
                    ))}
                </div>
            ...
            {cards.length > 0 && currentIndex !== null && (
                <div className="flex flex-col items-center pt-32 pb-12">
                    ...
                    <p className="font-pretendard font-medium text-[#737373] text-xl">{cards[currentIndex].content}</p>
                </div>
            )}
