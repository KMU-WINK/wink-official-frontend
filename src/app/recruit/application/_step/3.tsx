...
export default function Step3({ go, recruit, form }: RecruitStepProps) {
    ...
    <>
      ...
      >
        <Button
          variant="wink"
          onClick={async () => {
            if (!form.formState.errors.email && form.getValues('email')) {
              ...
              toast.error(form.formState.errors.email?.message || '이메일을 입력해주세요.');
            }
          }}
        >
          다음으로
